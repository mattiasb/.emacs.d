...
;; 2015-02-04 – Mattias Bengtsson <mattias.jc.bengtsson@gmail.com>
;;
;; This code was extracted from https://github.com/chrisdone/chrisdone-emacs/
;; Small adjustments to make flycheck not complain about code style was done.
;; The code was otherwise left intact.

;;; Code:

;;;###autoload
(defun align-string (begin end regexp count)
  "In each line of region (BEGIN to END) align first occurrence of REGEXP.
...
(defun align-all-strings (begin end regexp)
  "In each line of region (BEGIN to END) align all occurrences of REGEXP.
