...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode adwaita-dark-theme aggressive-indent align-by-current-symbol align-string all-the-icons-completion all-the-icons-dired ansible ansible-doc ansible-vault ascii-art-to-unicode auto-compile auto-dim-other-buffers browse-kill-ring buffer-move bury-successful-compilation cape cmake-mode corfu corfu-doc csharp-mode csv-mode cycle-quotes cython-mode daemons debian-el diff-hl diminish dired-hide-dotfiles dired-imenu dired-sidebar docker-compose-mode dockerfile-mode doom-modeline easy-repeat editorconfig eglot electric-operator emojify expand-region fancy-narrow fill-function-arguments fit-text-scale flimenu flymake-diagnostic-at-point flymake-yamllint flyspell-correct forge git-link git-modes gnu-elpa-keyring-update go-eldoc goto-line-preview groovy-mode guess-language haskell-mode hide-mode-line highlight-numbers history html5-schema ialign ibuffer-projectile iedit importmagic ini-mode jinja2-mode js2-mode json-mode lastpass ligature lisp-extra-font-lock lua-mode madhat2r-theme magit magit-filenotify magit-todos markdown-mode meson-mode move-dup mtg-deck-mode multiple-cursors mwim nginx-mode niceify-info pandoc-mode pcre2el php-mode pipenv powershell projectile python-black rainbow-mode ripgrep rfc-mode sass-mode sh-extra-font-lock shift-number smart-region spdx sqlup-mode string-inflection su systemd tmux-keys todotxt toml-mode vertico visual-regexp-steroids vterm wgrep which-key ws-butler yaml-mode yasnippet yatemplate))
