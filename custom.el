...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cape corfu corfu-doc vertico doom-modeline ligature ace-jump-mode add-node-modules-path aggressive-indent ahk-mode align-by-current-symbol align-string all-the-icons-dired ansible ansible-doc ansible-vault ascii-art-to-unicode auto-compile auto-dim-other-buffers auto-sudoedit browse-kill-ring buffer-move bury-successful-compilation cmake-mode csharp-mode csv-mode cycle-quotes cython-mode daemons debian-el diminish dired-hide-dotfiles dired-imenu dired-sidebar docker-compose-mode dockerfile-mode easy-repeat editorconfig eglot electric-operator emojify fancy-narrow fill-function-arguments fit-text-scale flimenu flycheck-cask flycheck-cython flycheck-package flycheck-pos-tip flycheck-rust flycheck-status-emoji flycheck-vala flycheck-yamllint flymake-diagnostic-at-point flymake-yamllint flyspell-correct forge git-gutter git-link gitconfig-mode gitignore-mode gnu-elpa-keyring-update go-eldoc goto-line-preview groovy-mode guess-language haskell-mode hide-mode-line highlight-numbers history html5-schema ialign ibuffer-projectile iedit importmagic ini-mode jinja2-mode js-auto-format-mode js2-refactor json-mode lastpass lisp-extra-font-lock list-unicode-display lsp-mode lsp-ui lua-mode madhat2r-theme magit magit-filenotify magit-todos markdown-mode meson-mode move-dup mtg-deck-mode mwim nginx-mode niceify-info pandoc-mode pcre2el php-mode pipenv powershell projectile py-autopep8 py-isort python-black rainbow-mode ripgrep sass-mode sh-extra-font-lock shift-number smart-region spdx sqlup-mode string-inflection switch-buffer-functions systemd tmux-keys todotxt toml-mode vala-mode vala-snippets visual-regexp-steroids vterm wgrep which-key ws-butler xref-js2 yaml-mode yatemplate))
