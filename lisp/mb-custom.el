...
(custom-set-variables
 ...
 '(easy-repeat-command-list
   '(backward-page beginning-of-defun default-text-scale-decrease default-text-scale-increase default-text-scale-reset end-of-defun forward-page git-gutter:next-hunk git-gutter:previous-hunk kill-buffer mb-cmd-toggle-programming-case-word-at-point mb-cmd-toggle-programming-case-word-at-point-reverse md/duplicate-down md/duplicate-up next-buffer next-error org-backward-heading-same-level org-forward-heading-same-level org-next-visible-heading org-previous-visible-heading other-window outline-backward-same-level outline-forward-same-level outline-next-visible-heading outline-previous-visible-heading outline-up-heading paredit-backward paredit-backward-up paredit-forward previous-error recenter-top-bottom scroll-down-command scroll-other-window scroll-up-command shift-number-down shift-number-up string-inflection-all-cycle table-heighten-cell table-narrow-cell table-shorten-cell table-widen-cell))
