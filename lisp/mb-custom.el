...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode ace-window aggressive-indent all-the-icons-completion all-the-icons-dired all-the-icons-ibuffer ansible ansible-doc ansible-vault ascii-art-to-unicode auto-compile auto-dark auto-dim-other-buffers browse-kill-ring bury-successful-compilation cape caps-lock cmake-mode company-ansible consult corfu csharp-mode csv-mode cycle-quotes dedicated default-text-scale devdocs devhelp diminish dired-imenu dired-sidebar docker-compose-mode doom-modeline easy-repeat eat editorconfig eglot eglot-tempel emacsql-sqlite-module envrc expand-region fill-function-arguments fit-text-scale flymake-eldev flymake-popon flymake-yamllint forge git-gutter git-link git-modes gnu-elpa-keyring-update go-mode goto-line-preview groovy-mode gsettings haskell-mode hide-mode-line highlight-numbers history hl-anything html5-schema ialign ibuffer-projectile iedit ini-mode inspector jinja2-mode jinx lastpass ligature lisp-extra-font-lock lua-mode madhat2r-theme magit magit-filenotify magit-todos markdown-mode meson-mode move-dup mtg-deck-mode multiple-cursors mwim nginx-mode niceify-info olivetti pandoc-mode pcre2el php-mode powershell projectile pydoc pytest pytest-realgud rainbow-mode realgud restclient rfc-mode ripgrep sass-mode sh-extra-font-lock shift-number smart-region spdx sql-indent sqlup-mode string-inflection su systemd tempel terraform-mode tmux-keys tmux-mode todotxt toml-mode treesit-auto tree-inspector unfill vertico visual-regexp-steroids visual-fill-column vundo wgrep which-key ws-butler yaml-mode))
