...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode adaptive-wrap aggressive-indent all-the-icons-completion all-the-icons-dired all-the-icons-ibuffer ansible ansible-doc ansible-vault ascii-art-to-unicode auto-compile auto-dark auto-dim-other-buffers beframe browse-kill-ring buffer-move bury-successful-compilation cape cmake-mode company-ansible corfu csharp-mode csv-mode cycle-quotes default-text-scale devhelp diminish dired-hide-dotfiles dired-imenu dired-sidebar docker-compose-mode doom-modeline easy-repeat eat editorconfig eglot eglot-tempel electric-operator emacsql-sqlite-module emojify envrc expand-region fill-function-arguments fit-text-scale flymake-diagnostic-at-point flymake-yamllint forge git-gutter git-link git-modes gnu-elpa-keyring-update go-eldoc goto-line-preview groovy-mode guess-language haskell-mode hide-mode-line highlight-numbers history hl-anything html5-schema ialign ibuffer-projectile iedit importmagic ini-mode inspector jinja2-mode jinx js2-mode json-mode lastpass ligature lisp-extra-font-lock lua-mode madhat2r-theme magit magit-filenotify magit-todos markdown-mode meson-mode move-dup mtg-deck-mode multiple-cursors mwim nginx-mode niceify-info olivetti pandoc-mode pcre2el php-mode powershell projectile pydoc pytest pytest-realgud python-black rainbow-mode realgud restclient rfc-mode ripgrep sass-mode sh-extra-font-lock shift-number smart-region smartscan spdx sql-indent sqlup-mode string-inflection su systemd tempel terraform-mode tmux-keys tmux-mode todotxt toml-mode treesit-auto tree-inspector vertico visual-regexp-steroids vterm vundo wgrep which-key ws-butler yaml-mode))
