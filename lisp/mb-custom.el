...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode adaptive-wrap aggressive-indent all-the-icons-completion all-the-icons-dired all-the-icons-ibuffer ansible ansible-doc ansible-vault ascii-art-to-unicode auto-compile auto-dim-other-buffers beframe browse-kill-ring buffer-move bury-successful-compilation cape cmake-mode company-ansible corfu csharp-mode csv-mode cycle-quotes cython-mode debian-el default-text-scale devhelp diminish dired-hide-dotfiles dired-imenu dired-sidebar docker-compose-mode dockerfile-mode doom-modeline easy-repeat eat editorconfig eglot electric-operator emacsql-sqlite-module emojify expand-region fill-function-arguments fit-text-scale flimenu flymake-diagnostic-at-point flymake-yamllint flyspell-correct forge git-gutter git-link git-modes gnu-elpa-keyring-update go-eldoc goto-line-preview groovy-mode guess-language haskell-mode hide-mode-line highlight-numbers history html5-schema ialign ibuffer-projectile iedit importmagic ini-mode inspector jinja2-mode jinx js2-mode json-mode lastpass ligature lisp-extra-font-lock lua-mode madhat2r-theme magit magit-filenotify magit-todos markdown-mode meson-mode move-dup mtg-deck-mode multiple-cursors mwim nginx-mode niceify-info pandoc-mode pcre2el php-mode powershell projectile python-black rainbow-mode restclient rfc-mode ripgrep sass-mode sh-extra-font-lock shift-number smart-region spdx sqlup-mode string-inflection su systemd tempel tmux-keys todotxt toml-mode tree-inspector vertico visual-regexp-steroids vterm vundo wgrep which-key ws-butler yaml-mode))
